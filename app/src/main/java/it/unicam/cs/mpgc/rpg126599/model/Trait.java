...
public enum Trait {
    ...
    MANIPOLATORE(RoleType.KILLER, "Manipolatore",
            "Enfatizza il depistaggio: i tuoi indizi falsi sono più efficaci nel confondere la Polizia.", 1, 4),
    ...
    private final int matchXpBonus;

    Trait(RoleType role, String displayName, String description, int requiredLevel, int matchXpBonus) {
        this.role = role;
        this.displayName = displayName;
        this.description = description;
        this.requiredLevel = requiredLevel;
        this.matchXpBonus = matchXpBonus;
    }
